"""
lab_utils_uni.py
    routines used in Course 1, Week2, labs1-3 dealing with single variables (uni-variate)
"""
...
def plt_intuition(x_train, y_train):
    ...
    @interact(w=(*w_range, 10), continuos_update=False)
    def func(w=150):
...
def plt_stationary(x_train, y_train):
    ...
    ax[1].text(0.5,0.95,"Click to choose w,b",  bbox=dict(facecolor='white', ec = 'black'), fontsize = 10, transform=ax[1].transAxes, verticalalignment = 'center', horizontalalignment= 'center')
